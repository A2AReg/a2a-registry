...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_clients_is_active"), "clients", ["is_active"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_client_entitlements_client_id"),
        "client_entitlements",
        ["client_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_client_entitlements_agent_id"),
        "client_entitlements",
        ["agent_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_client_entitlements_is_active"),
        "client_entitlements",
        ["is_active"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_peer_registries_name"), "peer_registries", ["name"], unique=False
    )
    op.create_index(
        op.f("ix_peer_registries_base_url"),
        "peer_registries",
        ["base_url"],
        unique=True,
    )
    op.create_index(
        op.f("ix_peer_registries_sync_enabled"),
        "peer_registries",
        ["sync_enabled"],
        unique=False,
    )
    op.create_index(
        op.f("ix_peer_registries_is_active"),
        "peer_registries",
        ["is_active"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_peer_syncs_peer_registry_id"),
        "peer_syncs",
        ["peer_registry_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_client_entitlements_is_active"), table_name="client_entitlements"
    )
    op.drop_index(
        op.f("ix_client_entitlements_agent_id"), table_name="client_entitlements"
    )
    op.drop_index(
        op.f("ix_client_entitlements_client_id"), table_name="client_entitlements"
    )
