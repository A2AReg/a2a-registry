...
from ..schemas.client import ClientCreate, ClientEntitlementCreate, ClientUpdate
...
class ClientService:
    ...
    def update_client(
        self, client_id: str, client_data: ClientUpdate
    ) -> Optional[Client]:
    ...
    def create_entitlement(
        self, entitlement_data: ClientEntitlementCreate
    ) -> ClientEntitlement:
    ...
    def get_entitlement(self, entitlement_id: str) -> Optional[ClientEntitlement]:
        ...
        return (
            self.db.query(ClientEntitlement)
            .filter(ClientEntitlement.id == entitlement_id)
            .first()
        )
    ...
    def revoke_client_entitlements(self, client_id: str) -> int:
        ...
        count = (
            self.db.query(ClientEntitlement)
            .filter(ClientEntitlement.client_id == client_id)
    ...
    def revoke_agent_entitlements(self, agent_id: str) -> int:
        ...
        count = (
            self.db.query(ClientEntitlement)
            .filter(ClientEntitlement.agent_id == agent_id)
            .update({"is_active": False})
        )
