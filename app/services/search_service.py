    ...
    def index_agent(self, agent: Agent) -> bool:
        ...
        try:
            ...
            self.es_client.index(
                index=settings.elasticsearch_index, id=agent.id, body=doc
            )
            return True
    ...
    def remove_agent(self, agent_id: str) -> bool:
        ...
        try:
            self.es_client.delete(
                index=settings.elasticsearch_index, id=agent_id, ignore=[404]
            )
            return True
        except Exception as e:
    ...
    def search_agents(
        ...
        try:
            ...
            pagination = {
                ...
                "total_pages": (total_count + search_request.per_page - 1)
