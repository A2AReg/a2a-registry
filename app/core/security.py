...
class InputValidator:
    ...
    def validate_agent_card(agent_card: Dict[str, Any]) -> List[str]:
        ...
        # Required fields
        required_fields = ["id", "name", "version", "description", "capabilities", "provider"]
...
class APIKeyManager:
    ...
    def validate_api_key(self, key: str) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "scopes": key_data.get("scopes", "").split(",") if key_data.get("scopes") else [],
...
class SecurityAuditLogger:
    ...
    def log_rate_limit_exceeded(self, client_id: str, endpoint: str, ip_address: str = None):
