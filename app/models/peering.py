...
class PeerRegistry(Base):
    ...
    # Relationships
    syncs = relationship("PeerSync", back_populates="peer_registry", cascade="all, delete-orphan")
...
class PeerSync(Base):
    ...
    # Foreign key
    peer_registry_id = Column(String, ForeignKey("peer_registries.id"), nullable=False, index=True)
